...
public class Homework1 {
    public static void main(String[] args) {
        //  1.1  Створити змінні примітивних типів, усіх можливих систем числень для кожного типу.\
        byte b1 = 10; // десяткова
        byte b2 = 0b110101; // двійкова
        byte b3 = 0xF; // шістнадцяткова система
        byte b4 = 012; // вісімкова система
        int a1 = 22;
        int a2 = 0b100;
        int a3 = 0xFF;
        int a4 = 023;
        ...
        System.out.println(d1 + " " + d4 + " тут дабли");
        System.out.println(f1 + " " + f4 + " тут флоати");
        System.out.println(c1 + " " + c2 + " " + c3 + " " + c4 + " тут чари");
        // тепер знаю що флоати і дабли не підтримують двійкову і вісімкову системи числення
    }
}
